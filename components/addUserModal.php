...
<body>
    ...
    <div id="addUserModal" class="modal">
        <span class="close" onclick="document.getElementById('addUserModal').style.display='none'"
            title="Close Modal">&times;</span>
        <form class="modal-content animate" action="dbServices/addUser.php" method="post">
            <div class="container">
                <h1>Προσθήκη Χρήστη</h1>

                <hr>
                <label for="uemail"><b>Email</b></label>
                <input type="text" value="" name="uemail" required>
                ...
                <div class="clearfix">
                    ...
                    <button type="submit" class="insertbtn">Προσθήκη</button>
                </div>
            </div>
        </form>
    </div>
